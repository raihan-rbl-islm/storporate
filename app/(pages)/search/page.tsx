  ...
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-8 md:py-12">
      <header className="mb-12">
        <h1 className="text-4xl font-bold tracking-tight">Search & Discover</h1>
      </header>
        ...
        <div className="lg:col-span-3">
          {q.trim() ? (
            ...
            <div className="py-20 text-center rounded-3xl border border-dashed border-border/50 bg-muted/10">
              ...
              <p className="text-muted-foreground">Enter a keyword to discover clubs, companies, jobs, events, and journals.</p>
            </div>
          )}
        </div>
      </div>
